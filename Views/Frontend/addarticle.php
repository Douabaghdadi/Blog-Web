                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-12">
                                        ...
                                        <label for="floatingInput">Titre</label>
                                            <input type="text" name="titre" id="titre" class="form-control" placeholder="" required="">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        ...
                                        <label for="floatingInput">Description</label>
                                            <textarea type="text" name="description" id="description" class="form-control" placeholder="" required=""></textarea>
