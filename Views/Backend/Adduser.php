...
if (isset($_REQUEST['add'])) {
  ...
  $check = getimagesize($_FILES["fileToUpload"]["tmp_name"]);
      ...
      if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
          ...
          $user = new User(1,$_POST['nom'],$_POST['prenom'], $_POST['login'],$_POST['email'],$date,$target_file,$_POST['pswd'],$Now,$_POST['genre'],$_POST['role']);
          $UserC->register($user);
...
submitBtn.addEventListener('click', function(event) {
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      <input id="submit-btn" type="submit" name="add" value="Ajouter">
    </div>
  </form>
</div>
